...
class RecipientsControllerTest < ActionController::TestCase
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post :create, :recipient => { :deleted_at => @recipient.deleted_at, :disabled_at => @recipient.disabled_at, :recipient_email => @recipient.recipient_email, :user_id => @recipient.user_id }
    end
  ...
  test "should update recipient" do
    put :update, :id => @recipient, :recipient => { :deleted_at => @recipient.deleted_at, :disabled_at => @recipient.disabled_at, :recipient_email => @recipient.recipient_email, :user_id => @recipient.user_id }
    assert_redirected_to recipient_path(assigns(:recipient))
  end
